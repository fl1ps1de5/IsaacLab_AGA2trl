...
class KinovaReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        # override events to bear in mind inital joint positions
        ...
        # override actions and adjust scale for kinova
        self.actions.arm_action = mdp.JointPositionActionCfg(
            asset_name="robot", joint_names=["j2n6s300_joint_[1-6]"], scale=0.2, use_default_offset=True
        )
